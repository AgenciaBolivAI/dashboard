...
export async function runAssistant(opts: {
  ...
  const system = [
    ...
    "- Pregunta de PRECIOS / cuánto cuesta algo / tarifas → SIEMPRE llama a get_pricing (precios EN VIVO). NUNCA cites cifras de precios de la guía ni de memoria; pueden estar desactualizadas. Convierte: 1 USD = 100 créditos (5 créditos = $0.05).",
