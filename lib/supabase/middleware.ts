...
/**
 * Refreshes the user's session on every request and returns either the
 * untouched response or a redirect when the route requires auth.
 *
 * Auth boundaries:
 *   - /dashboard/* and /admin/*  → require signed-in user
